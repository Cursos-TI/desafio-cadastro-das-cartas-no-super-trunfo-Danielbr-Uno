...
int main() {
    ...
    float populacao, populacao2, area, area2, densiPop, densiPop2, pib, pib2;
    ...
    scanf("%f", &pib);
    pib = pib * 1000000000; // Convertendo PIB para bilhões.
    ...
    printf("Digite o PIB da cidade: \n");
    scanf("%f", &pib2);
    pib2 = pib2 * 1000000000; //Convertendo PIB para bilhões
